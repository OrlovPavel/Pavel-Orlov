...
public:
    Matrix(size_t n, size_t m, size_t val);
...
Matrix::Matrix(size_t n, size_t m, size_t val) {
...
Matrix pow(Matrix& A, BigInteger k){
    Matrix res(A[0].size(), A[0].size(), 0);
